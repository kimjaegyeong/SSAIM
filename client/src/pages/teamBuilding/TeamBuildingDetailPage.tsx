...
const TeamBuildingDetailPage = () => {
  ...
  const handleSubmit = async () => {
    const formData = {
        ...
        infraLimit: data.infraLimit,
        infraCurrent: data.infraCurrent,
        backendLimit: data.backendLimit,
        backendCurrent: data.backendCurrent,
        frontLimit: data.frontLimit,
        frontCurrent: data.frontCurrent,
